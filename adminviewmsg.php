...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      <li class="nav-item">
        <a class="nav-link" href="admin.php" target="blank" style="color: #fff;">Admin <span class="sr-only">(current)</span></a>
      </li>
...
?>
        ...
        <div class="row">
            ...
            <a href='adminview.php?page_no=<?php echo $page_no; ?>&category=<?php echo $category;?>' class='btn btn-primary'><i class='fa fa-undo' aria-hidden='true'></i>Back to messages</a>
