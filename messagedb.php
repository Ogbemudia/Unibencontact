...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
  ...
  <main class="cd-main-content">
    ...
    <div class="cd-content-wrapper">
      ...
      <h4>Total Mails <?php echo $total_records; ?> | Unread Mails <?php echo $total_unread; ?></h4>
...
<?php
    if (isset($_GET['page_no']) && $_GET['page_no']!="") {
        ...
        while($row = mysqli_fetch_array($result)){
            ...
            echo "<tr>
                  ...
                  <div style='display:flex;'><input type='checkbox' name='mail[]' value=$id><span style='margin-left:4px;'>".$row['id']."</span></div></td>
                  <td>".$action."</td>
                  <td>".$sender."</td>
                  <td>".$row['email']."</td>
                  <td>".$subject."</td>
   ...
   <?php echo "<div style='float:right; display:flex; margin-right:10px;'>
   <select type='select' name='status' value='status' >                    
   <option value = '1'>Mark as?</option>
   <option value = 'unread'>Mark as Unread</option>
   <option value = 'Read'>Mark as Read</option></select>
   <select type='select' name='category1' value='category1'>                    
