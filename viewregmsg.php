...
$sql = "UPDATE contact_us SET action = 'Read' WHERE id = $id";
...
?>
        ...
        <div class="row">
            ...
            <a href='registry.php?page_no=<?php echo $page_no; ?>' class='btn btn-primary'><i class='fa fa-undo' aria-hidden='true'></i>Back to messages</a>            
