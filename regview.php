...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
  ...
  <main class="cd-main-content">
    <nav class="cd-side-nav js-cd-side-nav" style="font-size:20px">
      <ul class="cd-side__list js-cd-side__list">
        ...
        <ul class="cd-side__sub-item">
            <li class="cd-side__sub-item"><a href="registry.php" name="category" style="color:#BEC9B7; font-size:14px">Registry<br> Mails: <?php $registry->mails('registry') ?></a></li>
    ...
    <div style='display:flex'><input type='checkbox' name='mail[]' value=$id> <div style=padding-left:10px;>".$action."</div></div>
              ...
              <div style='float:right; margin-right:10px;'> <a href='regviewmsg.php?button=" . $row["id"]."&page_no=" .$page_no ."&category=".$category. "'><button type='button' value='button2' class='btn btn-primary'><span class='glyphicon glyphicon-eye-open'></span>View message</button></a> </div>   
